  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-red-500 text-white shadow hover:bg-red-600 active:scale-95",
        outline:
          "border border-zinc-200 bg-white shadow-sm hover:bg-zinc-50 text-zinc-900 active:scale-95",
        ghost: "hover:bg-zinc-100 text-zinc-700",
        link: "text-violet-600 underline-offset-4 hover:underline",
        secondary:
          "bg-zinc-100 text-zinc-900 shadow-sm hover:bg-zinc-200 active:scale-95",
        success:
          "bg-emerald-500 text-white shadow hover:bg-emerald-600 active:scale-95",
      },
      size: {
